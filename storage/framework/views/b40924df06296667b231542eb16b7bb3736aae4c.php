...
<?php $__env->startSection('navbar_header'); ?>
    <b><?php echo session('current_project_char') ?></b> - Finance & Accounting - Sales Backlog
<?php $__env->stopSection(); ?>

<?php $__env->startSection('header_title'); ?>
    Finance & Accounting - Sales Backlog
<?php $__env->stopSection(); ?>
                                    ...
                                    Table::create(array(
                                        ...
                                        "headers"=>array(
                                            array(
                                                ...
                                                "SALDO PER ".strtoupper(date('M Y', strtotime($cut_off)))=>array("colSpan"=>2, "rowSpan"=>2),
                                            ),
                                            array(
                                                (date('Y', strtotime($cut_off)))=>array("colSpan"=>2),
                                                (date('Y', strtotime($cut_off)) + 1)=>array("colSpan"=>2),
                                                (date('Y', strtotime($cut_off)) + 2)=>array("colSpan"=>2),
                                                "> ".(date('Y', strtotime($cut_off)) + 2)=>array("colSpan"=>2),
                                            )
                                        ),
                                        "showFooter"=>"bottom",
...
<script type="text/javascript">
    ...
    function getExcel() {
        ...
        var url = '<?php echo e(url("finance_accounting_sales_backlog_report_excel/proyek/cut_off")); ?>';
    ...
    function getPDF() {
        var proyek = <?php echo session('current_project') ?>;
        var cut_off = document.getElementById("txtCutOff").value;
        var url = '<?php echo e(url("finance_accounting_sales_backlog_report_pdf/proyek/cut_off")); ?>';
        url = url.replace('proyek', proyek);
        url = url.replace('cut_off', cut_off);
        window.location.href = url;
    }
    ...
    function getSubmit() {
        ...
        if(isValid == false) {
            ...
            var proyek = <?php echo session('current_project') ?>;
            var cut_off = document.getElementById("txtCutOff").value;
            var url = '<?php echo e(url("finance_accounting_sales_backlog_report/project/cut_off")); ?>';
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.mainLayouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dashboard/public_html/metland_reporting/resources/views/FinanceAccounting/SalesBacklog/sales_backlog.blade.php ENDPATH**/ ?>