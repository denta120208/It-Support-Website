        ...
        <div class="col-md">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="<?php echo e(url('saveAddTypeKeluhan')); ?>" method="post">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="example1" name="example1" border-style="hidden">
                            ...
                            ?>
                            <tbody>
                                <?php $__currentLoopData = $listTypeKeluhan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td style="text-align: center;"><?php echo e($no++); ?></td>
                                        <td style="text-align: center;"><?php echo e($data->DESC_CHAR); ?></td>
                                         <td>
                                            <a href="<?php echo e(URL('/viewDataTypeKeluhan/'.$data->MD_TYPE_KELUHAN_TICKETING_ID_INT)); ?>" class="btn btn-warning">Edit</a>
                                            <a href="#" class="btn btn-danger"onclick="swalDeleteData(<?php echo e($data->MD_TYPE_KELUHAN_TICKETING_ID_INT); ?>)">Delete</a>
                                        </td>
                                    </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.mainLayouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/support/public_html/metland_support/resources/views/MasterData/TypeKeluhan/viewListTypeKeluhan.blade.php ENDPATH**/ ?>