                        ...
                        <table id="TABLE_1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: left;"><?php echo e($data->TRANS_TICKET_NOCHAR); ?></td>
                                    <td style="text-align: left;"><?php echo e(ucwords($data->REQUEST_BY_USER)); ?></td>
                                    <td style="text-align: left;"><?php echo e(date('d/m/Y , h:i:s A',strtotime($data->created_at))); ?></td>
                                    <td style="text-align: left;"><?php echo e($data->JUDUL_TICKET); ?></td>
                                    <td style="text-align: left;"><?php echo e($data->PROJECT_NAME); ?></td>
                                    <td style="text-align: left;"><?php echo e(ucwords($data->created_by)); ?></td>
                        ...
                        <div class="row">
                            ...
                            <table id="TABLE_3" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: left;"><?php echo e(ucwords($data->REQUEST_BY_USER)); ?></td>
                                    <td style="text-align: left;"><?php echo e(date('d/m/Y , h:i:s A',strtotime($data->created_at))); ?></td>
                                    <td style="text-align: left;"><?php echo e(date('d/m/Y , h:i:s A',strtotime($data->updated_at))); ?></td>
                                    <td style="text-align: left;"><?php echo e($data->JUDUL_TICKET); ?></td>
                                    <td style="text-align: left;"><?php echo e($data->PROJECT_NAME); ?></td>
                                    <td style="text-align: left;"><?php echo e(ucwords($data->created_by)); ?></td>
                                    <td style="text-align: left;"><?php echo e($data->NAMA); ?></td>
                                    <td style="text-align: left;"><?php echo e($data->DESC_STATUS); ?></td>
                                    <td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.mainLayouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/support/public_html/metland_support/resources/views/Ticketing/listViewTicketing.blade.php ENDPATH**/ ?>