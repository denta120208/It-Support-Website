        ...
        <div class="col-md">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="<?php echo e(url('saveAddAplikasi')); ?>" method="post">
                    <?php echo e(csrf_field()); ?>

                        <div class="col-sm-3">
                            <div class="form-group">
                                <label>Tambah Aplikasi</label>
                                <input type="text" class="form-control" id="aplikasi" name="aplikasi" autocomplete="off" required>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="example1" name="example1" border-style="hidden">
                            ...
                            ?>
                            <tbody>
                                <?php $__currentLoopData = $listDataAplikasi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td style="text-align: center;"><?php echo e($no++); ?></td>
                                        <td style="text-align: center;"><?php echo e($data->DESC_CHAR); ?></td>
                                        <td style="text-align: center;"><?php echo e($data->DESC_ROLE); ?></td>
                                         <td>
                                            <a href="<?php echo e(URL('/viewDataAplikasi/'.$data->MD_APLIKASI_ID_INT)); ?>" class="btn btn-warning">Edit</a>
                                            <a href="#" class="btn btn-danger"onclick="swalDeleteData(<?php echo e($data->MD_APLIKASI_ID_INT); ?>)">Delete</a>
                                        </td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tbody>
    ...
    function swalDeleteData(param1) {
        ...
        allowOutsideClick: false,
            ...
            if (result.isConfirmed) {
                window.location.href = "/deleteDataAplikasi/" + param1;
            }
        });
    }
</script>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.mainLayouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/support/public_html/metland_support/resources/views/MasterData/Aplikasi/viewListAplikasi.blade.php ENDPATH**/ ?>