...
<?php $__env->startSection('navbar_header'); ?>
    <b><?php echo session('current_project_char') ?></b> - Legal - IMB & Sertifikat
<?php $__env->stopSection(); ?>

<?php $__env->startSection('header_title'); ?>
    Legal - IMB & Sertifikat
<?php $__env->stopSection(); ?>
                    ...
                    <form>
                        ...
                        <div class="row">
                            <div class="col-md" style="overflow-x:auto;">
                                ...
                                <?php
                                    Table::create(array(
                                        "dataStore"=>$report->dataStore('legal_imb_sertifikat_table1'),
                                        // "headers"=>array(
                                        //     array(
                                        //         ""=>array("colSpan"=>1),
                                        //         "AJB"=>array("colSpan"=>2),
                                ...
                                <?php
                                    Table::create(array(
                                        "dataStore"=>$report->dataStore('legal_imb_sertifikat_table2'),
                                        // "headers"=>array(
                                        //     array(
                                        //         ""=>array("colSpan"=>1),
                                        //         "AJB"=>array("colSpan"=>2),
...
<script type="text/javascript">
    ...
    function getExcel() {
        ...
        var url = '<?php echo e(url("legal_imb_sertifikat_report_excel/proyek/cut_off")); ?>';
    ...
    function getPDF() {
        var proyek = <?php echo session('current_project') ?>;
        var cut_off = document.getElementById("txtCutOff").value;
        var url = '<?php echo e(url("legal_imb_sertifikat_report_pdf/proyek/cut_off")); ?>';
        url = url.replace('proyek', proyek);
        url = url.replace('cut_off', cut_off);
        window.location.href = url;
    }
    ...
    function getSubmit() {
        ...
        if(isValid == false) {
            ...
            var proyek = <?php echo session('current_project') ?>;
            var cut_off = document.getElementById("txtCutOff").value;
            var url = '<?php echo e(url("legal_imb_sertifikat_report/proyek/cut_off")); ?>';
            url = url.replace('proyek', proyek);
            url = url.replace('cut_off', cut_off);
            window.location.href = url;
        }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.mainLayouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dashboard/public_html/metland_reporting/resources/views/Legal/IMBSertifikat/imb_sertifikat.blade.php ENDPATH**/ ?>