                        ...
                        <div class="row">
                            <div class="col-md" style="overflow-x:auto;">
                                ...
                                <?php
                                    ...
                                    Table::create(array(
                                        "dataStore"=>$report->dataStore('finance_accounting_marketing_promosi_table'),
                                        // "showFooter"=>"bottom",
                                        "themeBase"=>"bs4",
                                        "cssClass"=>array(
...
<script type="text/javascript">
    ...
    function getExcel() {
        ...
        var url = '<?php echo e(url("finance_accounting_marketing_promosi_report_excel/proyek/cut_off")); ?>';
    ...
    function getPDF() {
        var proyek = <?php echo session('current_project') ?>;
        var cut_off = document.getElementById("txtCutOff").value;
        var url = '<?php echo e(url("finance_accounting_marketing_promosi_report_pdf/proyek/cut_off")); ?>';
        url = url.replace('proyek', proyek);
        url = url.replace('cut_off', cut_off);
        window.location.href = url;
    }
    ...
    function getSubmit() {
        ...
        if(isValid == false) {
            ...
            var proyek = <?php echo session('current_project') ?>;
            var cut_off = document.getElementById("txtCutOff").value;
            var url = '<?php echo e(url("finance_accounting_marketing_promosi_report/project/cut_off")); ?>';
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.mainLayouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dashboard/public_html/metland_reporting/resources/views/FinanceAccounting/MarketingPromosi/marketing_promosi.blade.php ENDPATH**/ ?>