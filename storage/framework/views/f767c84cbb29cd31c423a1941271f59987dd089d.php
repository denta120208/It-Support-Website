    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <?php if(session('menuParentActive') == "dashboard"): ?>
          ...
          <li class="nav-item">
            <?php if(session('menuParentActive') == "masterData"): ?>
          ...
          <ul class="nav nav-treeview">
              <li class="nav-item">
                <?php if(session('menuSubActive') == "listUserIt"): ?>
                <a href="<?php echo e(route('viewListUserIt')); ?>" class="nav-link active">
                <?php else: ?>
                <a href="<?php echo e(route('viewListUserIt')); ?>" class="nav-link">
                <?php endif; ?>
          ...
          <ul class="nav nav-treeview">
              <li class="nav-item">
                <?php if(session('menuSubActive') == "listAplikasi"): ?>
                <a href="<?php echo e(route('viewListAplikasi')); ?>" class="nav-link active">
                <?php else: ?>
                <a href="<?php echo e(route('viewListAplikasi')); ?>" class="nav-link">
                <?php endif; ?>
                  <i class="far fa-circle nav-icon"></i>
                  <p>Aplikasi</p>
                </a>
          ...
          <ul class="nav nav-treeview">
              <li class="nav-item">
                <?php if(session('menuSubActive') == "listEmailSupport"): ?>
                <a href="<?php echo e(route('viewListEmailSupport')); ?>" class="nav-link active">
                <?php else: ?>
                <a href="<?php echo e(route('viewListEmailSupport')); ?>" class="nav-link">
                <?php endif; ?>
                  <i class="far fa-circle nav-icon"></i>
                  <p>Email Support</p>
                </a>
         ...
         <ul class="nav nav-treeview">
              <li class="nav-item">
                <?php if(session('menuSubActive') == "listRoleIt"): ?>
                <a href="<?php echo e(route('viewlistRoleIt')); ?>" class="nav-link active">
                <?php else: ?>
                <a href="<?php echo e(route('viewlistRoleIt')); ?>" class="nav-link">
                <?php endif; ?>
                  <i class="far fa-circle nav-icon"></i>
                  <p>Role It</p>
                </a>
          ...
          <ul class="nav nav-treeview">
              <li class="nav-item">
                <?php if(session('menuSubActive') == "listTypeKeluhan"): ?>
                <a href="<?php echo e(route('viewlistTypeKeluhan')); ?>" class="nav-link active">
                <?php else: ?>
                <a href="<?php echo e(route('viewlistTypeKeluhan')); ?>" class="nav-link">
                <?php endif; ?>
                  <i class="far fa-circle nav-icon"></i>
                  <p>Type Keluhan</p>
                </a>
          ...
          <?php if(session('menuParentActive') == "Ticketing"): ?>
          <li class="nav-item menu-open">
            <a href="javascript:void(0)" class="nav-link active">
          <?php else: ?>
          <li class="nav-item">
          ...
          <?php endif; ?>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <?php if(session('menuSubActive') == "listTicketing"): ?>
                <a href="<?php echo e(route('viewListTicketing')); ?>" class="nav-link active">
                <?php else: ?>
                <a href="<?php echo e(route('viewListTicketing')); ?>" class="nav-link">
                <?php endif; ?>
                  <i class="far fa-circle nav-icon"></i>
                  <p>Ticketing</p>
                </a>
          ...
          <?php if(session('menuParentActive') == "Reporting"): ?>
          <li class="nav-item menu-open">
            <a href="javascript:void(0)" class="nav-link active">
          <?php else: ?>
          <li class="nav-item">
          ...
          <?php endif; ?>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <?php if(session('menuSubActive') == "viewListReportSummary"): ?>
                <a href="<?php echo e(route('viewListReportSummary')); ?>" class="nav-link active">
                <?php else: ?>
                <a href="<?php echo e(route('viewListReportSummary')); ?>" class="nav-link">
                <?php endif; ?>
                  <i class="far fa-circle nav-icon"></i>
                  <p>Report Summary</p>
                </a>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <?php if(session('menuSubActive') == "viewListReportDetail"): ?>
                <a href="<?php echo e(route('viewListReportDetail')); ?>" class="nav-link active">
                <?php else: ?>
                <a href="<?php echo e(route('viewListReportDetail')); ?>" class="nav-link">
                <?php endif; ?>
                  <i class="far fa-circle nav-icon"></i>
                  <p>Report Detail</p>
                </a>
...
<?php /**PATH /home/support/public_html/metland_support/resources/views/layouts/mainLayouts.blade.php ENDPATH**/ ?>