...
<?php $__env->startSection('navbar_header'); ?>
    <b><?php echo session('current_project_char') ?></b> - Marketing - Demografi Asal Customer
<?php $__env->stopSection(); ?>

<?php $__env->startSection('header_title'); ?>
    Marketing - Demografi Asal Customer
<?php $__env->stopSection(); ?>
            ...
            <div class="card">
                <div class="card-body">
                    <form>
                        ...
                        <div class="row">
                            <div class="col-md" style="overflow-x:auto;">
                                <h5><b>DEMOGRAFI CUSTOMER (PROVINSI)</b></h5>
                                <span style="color: red;"><b>* Rp (Dalam Jutaan)</b></span>
                                <?php
                                    PivotTable::create(array(
                                        "dataStore"=>$report->dataStore('marketing_demografi_asal_customer_provinsi_table'),
                                ...
                                ?>
                                <br />
                                <h5><b>DEMOGRAFI CUSTOMER (KOTA)</b></h5>
                                <span style="color: red;"><b>* Rp (Dalam Jutaan)</b></span>
                                <?php
                                    PivotTable::create(array(
                                        "dataStore"=>$report->dataStore('marketing_demografi_asal_customer_kota_table'),
                                        'rowCollapseLevels' => array(0),
                                        'columnCollapseLevels' => array(0),
                                        'map' => array(
                                            'dataHeader' => function($dataField, $fieldInfo) {
...
<script type="text/javascript">
    ...
    function getExcel() {
        ...
        var url = '<?php echo e(url("marketing_demografi_asal_customer_report_excel/proyek/cut_off")); ?>';
    ...
    function getPDF() {
        var proyek = <?php echo session('current_project') ?>;
        var cut_off = document.getElementById("txtCutOff").value;
        var url = '<?php echo e(url("marketing_demografi_asal_customer_report_pdf/proyek/cut_off")); ?>';
        url = url.replace('proyek', proyek);
        url = url.replace('cut_off', cut_off);
        window.location.href = url;
    }
    ...
    function getSubmit() {
        ...
        if(isValid == false) {
            ...
            var proyek = <?php echo session('current_project') ?>;
            var cut_off = document.getElementById("txtCutOff").value;
            var url = '<?php echo e(url("marketing_demografi_asal_customer_report/proyek/cut_off")); ?>';
            url = url.replace('proyek', proyek);
            url = url.replace('cut_off', cut_off);
            window.location.href = url;
        }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.mainLayouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dashboard/public_html/metland_reporting/resources/views/Marketing/DemografiAsalCustomer/demografi_asal_customer.blade.php ENDPATH**/ ?>