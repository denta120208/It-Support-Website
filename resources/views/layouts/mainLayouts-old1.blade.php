...
if(empty(session('id'))) {
  header("Location: http://newexpense.metropolitanland.com/logout");
  die();
}
else {
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="javascript:void(0)" class="brand-link">
      ...
      <span class="brand-text font-weight-light">METLAND EXPENSE</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          @endif
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                @if(session('menuSubActive') == "marketing_sales")
                <a href="{{ route('marketing_sales') }}" class="nav-link active">
                @else
                <a href="{{ route('marketing_sales') }}" class="nav-link">
                @endif
