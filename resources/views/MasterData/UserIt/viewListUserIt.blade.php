                     ...
                     <div class="row" style="padding-left: 5px;">
                        <div class="col-sm-3">
                            <div class="form-group">
                                <a class="form-control btn btn-info" href="{{ route('viewAddUserIt') }}">
                                    Add User It
                                </a>
                            </div>
                        </div>
                                ...
                                @foreach($listDataIt as $data)
                                    <tr>
                                        ...
                                        <td style="text-align: center;">{{$data->DESC_CHAR}}</td>
                                         <td>
                                            <a href="{{URL('/viewDataUserIt/'.$data->MD_USER_IT_ID_INT)}}" class="btn btn-warning">View</a>
                                             <a href="#" class="btn btn-danger"onclick="swalDeleteData({{$data->MD_USER_IT_ID_INT}})">Delete</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
