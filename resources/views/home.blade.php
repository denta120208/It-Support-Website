...
DASHBOARD - <b>{{session('current_project_char')}}</b>
@endsection
            ...
            <form>       
                <div class="row">
                    ...
                    <table id="datatable3" name="datatable3" class="table table-bordered table-striped datatable3" >
                        ...
                        @endphp
                        <tbody>
                            @foreach($datatable3 as $data)
                        <tr>
                            <td style="text-align: left;">{{$no++}}</td>
                            <td style="text-align: left;" id="id" name="id">{{$data->PROJECT_NAME}}</td>
                            <td style="text-align: left;" class="komplain hover" id="komplain" name="komplain" onclick="getKomplain({{$data->PROJECT_NO_CHAR}})">{{$data->KOMPLAIN}}</td>
                            <td style="text-align: left;" class="permintaan hover" id="permintaan" name="permintaan"onclick="getPermintaan({{$data->PROJECT_NO_CHAR}})">{{$data->PERMINTAAN}}</td>
                            <td style="text-align: left;" class="informasi hover"id="informasi" name="informasi"onclick="getInformasi({{$data->PROJECT_NO_CHAR}})">{{$data->INFORMASI}}</td>
                        ...
                        <tfoot>
                            ...
                            <th>{{$totalTicket[0]->TOTAL_TICKET}}</th>
                        </tfoot>
                    </table>
                    </div>
                </div>
            ...
            <form>       
                <div class="row">
                    ...
                    <table id="datatable5" name="datatable5" class="table table-bordered table-striped" >
                        ...
                        @endphp
                        <tbody>
                            @foreach($listTicketByPic as $data)
                        <tr>
                            <td style="text-align: left;">{{$no++}}</td>
                            <td style="text-align: left;">{{$data->NAMA}}</td>
                            <td style="text-align: left;"class="open hover" id="open" name="open" onclick="getOpen({{$data->MD_USER_IT_ID_INT}})">{{$data->OPEN}}</td>
                            <td style="text-align: left;"class="hold hover" id="hold" name="hold" onclick="getHold({{$data->MD_USER_IT_ID_INT}})">{{$data->HOLD}}</td>
                            <td style="text-align: left;"class="progress1 hover" onclick="getProgress({{$data->MD_USER_IT_ID_INT}})">{{$data->PROGRESS}}</td>
                            <td style="text-align: left;"class="close2 hover" onclick="getClose({{$data->MD_USER_IT_ID_INT}})">{{$data->CLOSE}}</td>
                            <td style="text-align: left;"class="reject hover" id="reject" name="reject" onclick="getReject({{$data->MD_USER_IT_ID_INT}})">{{$data->REJECT}}</td>
                            <td style="text-align: left;">{{$data->JUMLAH_TICKET}}</td>
                        </tr>
                            @endforeach
                        </tbody>
                        <tfoot>
