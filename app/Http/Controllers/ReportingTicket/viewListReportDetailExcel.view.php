...
<?php if(count($this->dataStore('report_ticket_detail_excel')->all()) > 0) { ?>
<div sheet-name="<?php echo $sheet1; ?>">
    ...
    <?php
        Table::create(array(
            "dataSource" => $report->dataStore('report_ticket_detail_excel'),
            "showFooter"=>"false",
            "columns"=>array(
                ...
                "created_at" => ["label" => "Trx.Date", "formatValue" => function($value, $row) { return $value; }],
                ...
                "DESC_CHAR" => ["label" => "Status", "formatValue" => function($value, $row) { return $value; }],
            ),
            "excelStyle" => [
                ...
                "cell" => function($colName, $value, $row) {
                    if($colName == "TRANS_TICKET_NOCHAR"||$colName == "REQUEST_BY_USER"||$colName == "created_at"||$colName == "JUDUL_TICKET"||$colName == "PROJECT_NAME"||$colName == "created_by"||$colName == "JUMLAH_TICKET"||$colName == "NAMA"||$colName == "DESC_CHAR") {
                        return [
                            'font' => [
                                'italic' => false,
                                'color' => [
    ...
    <?php
        Table::create(array(
            "dataSource" => $report->dataStore('report_ticket_detail_grouping_excel'),
            "showFooter"=>"false",
            "columns"=>array(
                "TRANS_TICKET_NOCHAR" => ["label" => "No Ticket", "formatValue" => function($value, $row) { return $value; }],
                "REQUEST_BY_USER" => ["label" => "User Request", "formatValue" => function($value, $row) { return $value; }],
